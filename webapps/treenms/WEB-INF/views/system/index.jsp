        ...
        <div id="northPanel" data-options="region: 'north', border: false" style="height: 80px; overflow: hidden;">
            ...
            <div id="topbar" class="top-bar"  style="width: 100%;height:52px; background: #0092dc url('${ctx}/static/images/mosaic-pattern.png') repeat;">
                 ...
                 <div class="top-bar-left">
                    <h1 style="margin-left: 10px; margin-top: 10px;color: #fff"> <img src="${ctx}/static/images/logo.png" >TreeSoft数据库管理系统<span style="color:#00824D;font-size:14px; font-weight:bold;">&nbsp;TreeNMS</span>  <span style="color: #fff;font-size:12px;">V1.7.4</span> </h1>
                </div>
                ...
                <div class="top-bar-right"  >
                    <div id="timerSpan"> 
                     ...
                     <div id="operator" style="padding:5px;height:auto">
                       <div style="padding-right:10px;height:auto;float:right">
                         
                         <c:if test="${fn:contains(permission,'monitor')}"> 
                         <div style="padding-right:20px; display:inline; cursor:pointer;">
                                 <img class="imageHead"  src="${ctx}/static/images/alarm.gif" onclick="javascript:infoData()"  title="实时状态监控"/>
                         </div> 
                         </c:if>
                         
                          <c:if test="${fn:contains(permission,'backdatabase')}">   
                          <div style="padding-right:20px; display:inline; cursor:pointer;">
                                 <img  class="imageHead" src="${ctx}/static/images/btn_hd_backup.gif" onclick="javascript:backupDatabase()"  title="备份/还原"/>
                         </div> 
                         </c:if>
                         
                         <c:if test="${fn:contains(permission,'json')}">  
                         <div style="padding-right:20px; display:inline; cursor:pointer;">
                                 <img class="imageHead"  src="${ctx}/static/images/btn_json.gif" onclick="javascript:jsonFormat()"  title="Json格式化"/>
                          </div>
                        </c:if>
                          
                          <div style="padding-right:20px; display:inline; cursor:pointer;">
                                 <img class="imageHead"  src="${ctx}/static/images/btn_hd_heart.gif" onclick="javascript:contribute()"  title="捐赠"/>
                          </div> 
                         ...
                         <c:if test="${fn:contains(permission,'config')}">  
                           <div style="padding-right:20px; display:inline; cursor:pointer;">
                                 <img class="imageHead"  src="${ctx}/static/images/btn_hd_support.gif" onclick="javascript:ShowConfigPage()"  title="数据库配置"/>
                          </div>  
                         </c:if>
                          
                           <div style="padding-right:20px; display:inline;cursor:pointer;" >
                               <img  class="imageHead"  src="${ctx}/static/images/btn_hd_pass.gif"  onclick="javascript:ShowPasswordDialog()"  title="修改用户密码"/>
                          </div>  
                          
                          <!-- 
                          <div style="padding-right:20px; display:inline;cursor:pointer;">
                             <img class="imageHead"  src="${ctx}/static/images/btn_hd_help.gif" onclick="javascript:help()"  title="帮助"/>
                          </div>
                           -->
                          <div style=" display:inline;cursor:pointer; ">
                             <img id="btnExit" class="imageHead" src="${ctx}/static/images/btn_hd_exit.gif" title="注销"/> 
	       		          </div> 
